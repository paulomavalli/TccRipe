            ...
            try
            {
                ...
                var getQuestions = new List<TypeQuestions>
                {
                    new TypeQuestions { TypeId = "1",
                                        TypeDescription = "A Organização",
                                        QuestionDescription =  new List<string> { "Explora adequadamente as ameaças identificadas pela ocorrência de determinados riscos?","Explora adequadamente as oportunidades identificadas pela    ocorrência de determinados riscos?","Depende das iniciativas de caráter individual para o sucesso do gerenciamento de riscos?","É uma ·organização 'orientada a riscos'?","Tem alta probabilidade de ocorrência de eventos que impactem fortemente e negativamente?","Já está sofrendo algum tipo de prejuízo por não explorar o gerenciamento de risco  de forma adequada?"},
                                      } ,
